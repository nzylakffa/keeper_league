...
if uploaded_file is not None:
    ...
    Round_5_Value = round(data[data['Rank'].between((((leagues*4)+1)),(leagues*5))]['Value'].mean() - 0.70, 2)
    Round_6_Value = round(data[data['Rank'].between((((leagues*5)+1)),(leagues*6))]['Value'].mean() - 1.0, 2)
    Round_7_Value = round(data[data['Rank'].between((((leagues*6)+1)),(leagues*7))]['Value'].mean() - 1.3, 2)
    Round_8_Value = round(data[data['Rank'].between((((leagues*7)+1)),(leagues*8))]['Value'].mean() - 1.60, 2)
    Round_9_Value = round(data[data['Rank'].between((((leagues*8)+1)),(leagues*9))]['Value'].mean() - 1.90, 2)
    Round_10_Value = round(data[data['Rank'].between((((leagues*9)+1)),(leagues*10))]['Value'].mean() - 2.10, 2)
    Round_11_Value = round(data[data['Rank'].between((((leagues*10)+1)),(leagues*11))]['Value'].mean() - 2.20, 2)
    Round_12_Value = round(data[data['Rank'].between((((leagues*11)+1)),(leagues*12))]['Value'].mean() - 2.40, 2)
    Round_13_Value = round(data[data['Rank'].between((((leagues*12)+1)),(leagues*13))]['Value'].mean() - 2.65, 2)
    Round_14_Value = round(data[data['Rank'].between((((leagues*13)+1)),(leagues*14))]['Value'].mean() - 2.90, 2)
    Round_15_Value = round(data[data['Rank'].between((((leagues*14)+1)),(leagues*15))]['Value'].mean() - 3.1, 2)
    Round_16_Value = round(data[data['Rank'].between((((leagues*15)+1)),(leagues*16))]['Value'].mean() - 3.2, 2)
    Round_17_Value = round(data[data['Rank'].between((((leagues*16)+1)),(leagues*17))]['Value'].mean() - 3.3, 2)
    Round_18_Value = round(data[data['Rank'].between((((leagues*17)+1)),(leagues*18))]['Value'].mean() - 3.4, 2)
    Round_19_Value = round(data[data['Rank'].between((((leagues*18)+1)),(leagues*19))]['Value'].mean() - 3.5, 2)
    Round_20_Value = round(data[data['Rank'].between((((leagues*19)+1)),(leagues*20))]['Value'].mean() - 3.6, 2)
